...
import { Stethoscope, User, Mail, Lock, Phone, ArrowRight, AlertCircle, Loader2, Eye, EyeOff } from 'lucide-react';
...
const Register = () => {
  ...
  const handlePhoneChange = (e) => {
    ...
    if (raw.length > 5) {
      setPhone(`${raw.slice(0, 5)} ${raw.slice(5)}`);
    } else {
      setPhone(raw);
    }
  };
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-xl max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Book appointments, share symptoms & get AI follow-up guides</p>
        </div>
